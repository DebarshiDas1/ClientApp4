...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ClientApp4", Version = "v1" });
...
builder.Services.AddTransient<ClientApp4Context>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "ClientApp4 API v1");
