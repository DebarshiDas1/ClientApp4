...
using ClientApp4.Entities;

namespace ClientApp4.Data
{
    public class ClientApp4Context : DbContext
    {
        protected override void OnConfiguring(Microsoft.EntityFrameworkCore.DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-7723PEB\\SQLEXPRESS;Initial Catalog=T631688_ClientApp4;Persist Security Info=True;user id=sa;password=qwerty123;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
