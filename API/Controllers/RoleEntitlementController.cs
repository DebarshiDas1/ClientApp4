...
using ClientApp4.Filter;
using ClientApp4.Entities;
using ClientApp4.Authorization;
...
namespace ClientApp4.Controllers
{
    ...
    {
        private readonly ClientApp4Context _context;

        public RoleEntitlementController(ClientApp4Context context)
        {
            _context = context;
        }
